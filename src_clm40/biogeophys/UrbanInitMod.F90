...
!
    ...
    real(r8), pointer :: wtr_qflx_runoff_u(:,:)! tracer Urban total runoff (qflx_drain+qflx_surf) (mm H2O /s)
!
! !CALLED FROM:
! subroutine initialize
!
...
!-----------------------------------------------------------------------
    ...
    wtr_qflx_runoff_u  => cwf%wtr_qflx_runoff_u
